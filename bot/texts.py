...
# Сообщение команды /app. Короткое: смысл в самой кнопке, которая приходит
# вместе с ним в нижнем меню.
OPEN_APP = (
    "Кнопка внизу — «✦ Возможности отдела».\n\n"
    "Там карточки задач отдела, готовые решения с инструкциями, поток работ и ваши заявки. Заявка оформляется оттуда: из темы или из конкретного решения."
)
