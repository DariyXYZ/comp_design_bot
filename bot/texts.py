...
SENT_NO_DEPT = (
    "Заявка №{req_id} создана в Pyrus, но чат отдела ещё не настроен — "
...
SENT_DEPT_FAILED = (
    "Заявка №{req_id} создана в Pyrus, но не удалось отправить её в чат отдела — "
...
ASK_CLARIFY_QUESTION = (
    "Заявка №{req_id}: отмечено «Требуется уточнение».\n"
    "Напиши сюда вопрос заявителю — перешлю ему, ответ придёт в задачу и в эту ветку."
)
CLARIFY_QUESTION_SAVED = "Принято — вопрос по заявке №{req_id} отправлен заявителю."
CLARIFY_QUESTION_NOTIFY = (
    "Отделу нужно уточнение по заявке №{req_id}:\n{question}\n\n"
