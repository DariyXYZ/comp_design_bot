...
WELCOME = (
    ...
    "• «Возможности отдела» — карточки типовых кейсов с примерами\n"
...
INFO = (
    "Как это работает:\n\n"
    "1. Выбираете кейс, который похож на вашу задачу (или «Нетиповая задача», если не похож ни один).\n"
...
ASK_DESCRIPTION = (
    "Кейс: <b>{case_title}</b>\n\n"
    "Опишите задачу свободным текстом: что за проект, какая стадия, "
