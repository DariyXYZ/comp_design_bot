        ...
        problem || note ? (
          <>
            ...
            {/* В сложенном виде подписи нет: кнопка называет действие сама, а
                лишняя строка над ней — это высота, отнятая у карточки. Про
                загрузку картинок и про пропавшую тему говорим всегда: это не
                подсказка, а причина, по которой кнопка не сработает. */}
