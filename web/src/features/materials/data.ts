...
export const MATERIALS: readonly Material[] = [
  ...
  },
  {
    ...
    topic: "unique",
    type: "case",
    title: "ФСК Шеногин-Сити — ламели в разном повороте",
    summary: "Каждая ламель фасада повёрнута по-своему; модель и выгрузка в SketchUp",
    project: "1-34-2026-Шеногин-Сити",
    media: "Фасад с ламелями переменного поворота",
    steps: [
      "Посмотреть на превью, как поворот ламели меняется по фасаду",
      "Поставить плагин Tundra: установщик лежит рядом, в папке tundra01",
      "Открыть Модель.3dm и определение — оно переиспользовано с Coldy Красносельской",
      "Готовые ламели уехали в SketchUp: ламели.skp лежит в той же папке",
    ],
    files: "X:\\CompDesign_Projects\\Exchange\\1-34-2026-Шеногин-Сити",
    updated: "8 сентября",
    cover: "/materials/case-shenogina.jpg",
  },
  {
