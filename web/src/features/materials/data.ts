 ...
 * сделать: повторить сделанное, взять готовый инструмент или собрать из
 * вариантов. Поэтому в интерфейсе стоят эти подписи, а не внутренние.
 */
export const MATERIAL_TYPE_LABEL: Record<MaterialType, string> = {
  case: "Уже делали",
  tool: "Готовый инструмент",
  module: "Набор вариантов",
};
