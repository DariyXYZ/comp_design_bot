 ...
 *
 * Состав сверен с отделом 3 сентября 2026 и уточнён 11 сентября: к расчёту
 * ветрового комфорта добавлена тентовая конструкция на Маши Порываевой.
 *
...
export const FEED: readonly FeedItem[] = [
  ...
  // отдаёт, а не его внутренняя кухня. Сданное отсюда уезжает в готовые кейсы:
  // так ушли панели Бишкека (3 сентября, `case-bishkek-panels`) и ламели
  // Шеногин-Сити (8 сентября, `case-shenogina`).
  // ──────────────────────────────────────────────────────────────────────
  {
    id: "f-alfa-tent",
    title: "Создание тентовой конструкции для защиты двора от ветра и осадков",
  ...
  // ──────────────────────────────────────────────────────────────────────
  // Сделанное, сверху вниз по свежести. Даты есть там, где они известны: у
  // задач, закрытых пачкой 3 сентября, они нигде не записаны, и выдумывать их
  // здесь нельзя — строка просто покажет «Готово».
  // ──────────────────────────────────────────────────────────────────────
  {
    id: "f-shenogina-louvers",
    title: "Ламели фасада — параметрическая модель",
    project: "1-34-2026-Шеногин-Сити",
    status: "done",
    files: "X:\\CompDesign_Projects\\Exchange\\1-34-2026-Шеногин-Сити",
    when: "8 сентября",
