...
const golos = Golos_Text({
  ...
  // 800 не осталось ни в одном правиле: заголовок главного экрана, который им
  // набирался, уехал вместе с переездом на шторку. Лишнее начертание — это два
  // лишних файла шрифта (кириллица и латиница) на каждом открытии.
